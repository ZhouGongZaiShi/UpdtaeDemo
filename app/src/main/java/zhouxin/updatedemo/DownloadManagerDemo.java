...
public class DownloadManagerDemo extends Activity {
    ...
    public static final String APK_URL = "http://apkdl.binfun.tv:5000/apk/BinFun4TV0.1_80v0.1.160721.1_shafa_release.apk";
//    public static final String APK_URL = "http://img.meilishuo.net/css/images/AndroidShare/Meilishuo_3.6.1_10006.apk";
    ...
    private DownloadManagerUtil mDownloadManagerUtil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDownloadManagerUtil = new DownloadManagerUtil(downloadManager);
    ...
    protected void onResume() {
        ...
        getContentResolver().registerContentObserver(DownloadManagerUtil.CONTENT_URI, true, downloadObserver);
        updateView();
    }
    ...
    private void initData() {
         ...
         */
        downloadId = SPUtils.getLong(this, KEY_NAME_DOWNLOAD_ID);
//        updateView();
...
//                request.setDestinationInExternalPublicDir(DOWNLOAD_FOLDER_NAME, DOWNLOAD_FILE_NAME);
                ...
                SPUtils.putLong(DownloadManagerDemo.this, KEY_NAME_DOWNLOAD_ID, downloadId);
                updateView();
            }
        });
...
//                updateView();
                ...
                if (mDownloadManagerUtil.getStatusById(downloadId) == DownloadManager.STATUS_SUCCESSFUL) {
    ...
    public void updateView() {
        int[] bytesAndStatus = mDownloadManagerUtil.getBytesAndStatus(downloadId);
                    ...
                    if (isDownloading(status)) {
                        ...
                        if (status == DownloadManager.STATUS_FAILED) {
                            ...
                            downloadButton.setText("下载成功");
                                Uri uri = Uri.fromFile(new File(mDownloadManagerUtil.getFileName(downloadId)));
